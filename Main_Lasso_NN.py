...
import itertools
from Partitions import projection_matrix_partition, matrix_Sparsity_IntervalPartition, generate_list_of_lists, Coarsen_Partition_NN, check_partition,  Hard_Partition_NN
...
d = 40
d0 = 4
Iter_T = np.linspace(400,20000,100)
SampleEachT = 100
...
#            phi_hat_raw = catoni_esti(X_hist, 0.05, vari)
    ...
    excel_file_path = 'data_Lasso_NN_'+str(d) + '.xlsx'
